...
module Haml
  ...
  # {Haml::HamlHelpers} is automatically included in the context
...
MESSAGE
      ...
      # Raises an error.
      #
      # @raise [Haml::HamlError] The error
      def to_s
        raise Haml::HamlError.new(@message)
      ...
      def inspect
        "Haml::HamlHelpers::ErrorReturn(#{@message.inspect})"
      end
    end
    ...
    def haml_tag(name, *rest, &block)
      ...
      attributes = Haml::HamlAttributeBuilder.build_attributes(haml_buffer.html?,
    ...
    #
    # This function, unlike other {Haml::HamlHelpers} functions,
    ...
    def merge_name_and_attributes(name, attributes_hash = {})
      ...
      return $1 || "div", HamlAttributeBuilder.merge_attributes!(
        Haml::HamlParser.parse_class_and_id($2), attributes_hash)
    end

    # Runs a block of code with the given buffer as the currently active buffer.
    #
    # @param buffer [Haml::HamlBuffer] The Haml buffer to use temporarily
    ...
    # The current {Haml::HamlBuffer} object.
    #
    # @return [Haml::HamlBuffer]
    def haml_buffer
