...
module Haml
  ...
  class HamlOptions
    ...
    class << self
      ...
      # @return Hash
      def defaults
        @defaults ||= Haml::HamlTempleEngine.options.to_hash.merge(encoding: 'UTF-8')
      end
      ...
      # Returns a subset of defaults: those that {Haml::HamlBuffer} cares about.
    ...
    # preserved using the {Haml::HamlHelpers#preserve} helper. This means that any
    ...
    # The parser class to use. Defaults to Haml::HamlParser.
    attr_accessor :parser_class

    # The compiler class to use. Defaults to Haml::HamlCompiler.
    ...
    def format=(value)
      unless self.class.valid_formats.include?(value)
        raise Haml::HamlError, "Invalid output format #{value.inspect}"
      end
      @format = value
    end
    ...
    # Returns a non-default subset of options: those that {Haml::HamlBuffer} cares about.
