...
module Haml
  ...
  class Options
    ...
    # The buffer class for Temple::Generators::RailsOutputBuffer to use.
    # Defaults to ActiveSupport::SafeBuffer.
    attr_accessor :buffer_class

    # The generator class to use. Defaults to Temple::Generators::ArrayBuffer.
    attr_accessor :generator

    # Support Rails html_safe? or not
    attr_accessor :use_html_safe
